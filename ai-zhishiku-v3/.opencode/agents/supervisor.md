...
| 子 Agent | 脚本 | 说明 |
|---|---|---|
| Collector | `python -m workflows.collector --sources github,rss --limit 20` | 采集原始数据到 `knowledge/raw/` |
| Analyzer | `python -m workflows.analyzer` | 分析数据到 `knowledge/analyzer_output/` |
| Organizer | `python -m workflows.organizer` | 整理归档到 `knowledge/articles/` |
| Reviewer | `python -m workflows.reviewer` | 审核条目状态 |
